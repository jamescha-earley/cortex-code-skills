...
A comprehensive list of AI writing anti-patterns. Source: [tropes.fyi](https://tropes.fyi/)
Original skill by [Guillaume Laforge](https://github.com/glaforge/deslopify).
...
Tacking a present participle ("-ing") phrase onto the end of a sentence to inject shallow analysis that says nothing. Phrases like "highlighting its importance", "reflecting broader trends", or "contributing to the development of...".
...
After making a claim, AI illustrates it with a stream of verbless gerund fragments. The first sentence already said everything. The fragments add nothing except word count and that familiar AI cadence.
...
Excessive use of very short sentences or sentence fragments as standalone paragraphs for manufactured emphasis. No real person writes first drafts this way because it doesn't match how humans think or speak.
...
Every bullet point or list item starts with a bolded phrase or sentence. Almost nobody formats lists this way when writing by hand. A telltale sign of AI-generated documentation, blog posts, and README files (especially with emojis).
...
**Avoid patterns like:**
- "Input -> Processing -> Output" (with unicode arrows)
